...
%Busco los tiempos en los que la fo no es nula
tiempos=[0.875 1.11;1.30 1.39;1.39 1.47;1.47 1.575;1.69 1.83;2.005 2.098;2.11 2.36;2.36 2.47;2.54 2.72;2.81 2.97;2.97 3.216;3.35 3.48;3.605 3.72];
save tiempos;
sordos=[t(1) 0.875;1.11 1.30;1.575 1.69;1.83 2.005;2.098 2.11; 2.47 2.54;2.72 2.81;3.126 3.35;3.48 3.605;3.72 4.088];
save sordos;
...
alturas_segmentos=[0.2;0.2;0.2;0.2;0.1;0.2;0.2;0.12;0.08;0.06;0.05;0.15;0.03];
...
segmento3=psola(audio,T,periodo(3),3,cant_picos_por_segmento,loc_picos,73,porcentaje_solap);
segmento4=psola(audio,T,periodo(4),4,cant_picos_por_segmento,loc_picos,98,porcentaje_solap);
segmento5=psola(audio,T,periodo(5),5,cant_picos_por_segmento,loc_picos,120,porcentaje_solap);
segmento6=psola(audio,T,periodo(6),6,cant_picos_por_segmento,loc_picos,154,porcentaje_solap);
segmento7=psola(audio,T,periodo(7),7,cant_picos_por_segmento,loc_picos,178,porcentaje_solap);
segmento8=psola(audio,T,periodo(8),8,cant_picos_por_segmento,loc_picos,219,porcentaje_solap);
segmento9=psola(audio,T,periodo(9),9,cant_picos_por_segmento,loc_picos,234,porcentaje_solap);
segmento10=psola(audio,T,periodo(10),10,cant_picos_por_segmento,loc_picos,261,porcentaje_solap);
segmento11=psola(audio,T,periodo(11),11,cant_picos_por_segmento,loc_picos,289,porcentaje_solap);
segmento12=psola(audio,T,periodo(12),12,cant_picos_por_segmento,loc_picos,332,porcentaje_solap);
segmento13=psola(audio,T,periodo(13),13,cant_picos_por_segmento,loc_picos,353,porcentaje_solap);
%segmento1(65:100)=segmento1(65:100)/10000;
%segmento2(30:50)=segmento2(30:50)/10;
%segmento3(30:55)=segmento3(30:55)/10;
%segmento4(40:60)=segmento4(40:60)/10;
%segmento5(30:60)=segmento5(30:60)/10;%hasta aca andaba
%segmento6(30:60)=segmento6(30:60)/10;
...
audio_modificado=[sordo1;segmento1;sordo2;segmento2;segmento3;segmento4;sordo3;segmento5;sordo4;segmento6;sordo5;segmento7;segmento8;sordo6;segmento9;sordo7;segmento10;segmento11;sordo8;segmento12;sordo9;segmento13;sordo10];
