...
segmento1=psola(audio,T,2*0.0057,1,cant_picos_por_segmento,loc_picos,1,porcentaje_solap);
segmento2=psola(audio,T,2*0.00286,2,cant_picos_por_segmento,loc_picos,43,porcentaje_solap);
