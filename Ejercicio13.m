...
[P,t_ros]=generador_pulsos_f0_lineal_restando(fo1,fo2,n_ciclos,fs,Po);
figure (1)
plot(t_ros,P);
...
ylabel('Amplitud');
axis([0 0.025 0 1]);
print('pulsos_gloticos_13.png','-dpng');

dft_P=fft(P,10000);
dft_P=dft_P/length(dft_P);
...
%pause(4);
sound(a_generada,fs);
audiowrite('a_generada_fo_lineal_13.wav',a_generada,fs);
pause(4);
...
sound(e_generada,fs);
audiowrite('e_generada_fo_lineal_13.wav',e_generada,fs);
pause(4);
...
audiowrite('i_generada_fo_lineal_13.wav',i_generada,fs);
sound(i_generada,fs);
pause(4);
...
audiowrite('o_generada_fo_lineal_13.wav',o_generada,fs);
sound(o_generada,fs);
pause(4);
...
audiowrite('u_generada_fo_lineal_13.wav',u_generada,fs);
sound(u_generada,fs);
pause(4);
%print('u_generada.png','-dpng');
vocales=[a_generada;e_generada;i_generada;o_generada;u_generada];
audiowrite('vocales_disminucion.wav',vocales,fs);

ancho_ventana_ceps=0.07;%antes 0.07
corrimiento=0.01;%antes 0.01

[ceps_a,foa,tfoa]=cepstrogram_beta(a_generada,Ts,ancho_ventana_ceps,corrimiento);
x = [0 2.65];
y = [2 20];
image(x,y,ceps_a,'CDataMapping','scaled');
line([0 2.65],[5 5],'Color','k');
line([0 2.65],[10 10],'Color','k');
xlabel('Tiempo [s]');
ylabel('Quefrencia [ms]');
title('Diagrama tiempo-quefrencia "a" generada');
colorbar
print('tiempo_quefrencia_a_13.png','-dpng');

[ceps_e,foe,tfoe]=cepstrogram_beta(e_generada,Ts,ancho_ventana_ceps,corrimiento);
x = [0 2.65];
y = [2 20];
...
colorbar
print('tiempo_quefrencia_e_13.png','-dpng');

[ceps_i,foi,tfoi]=cepstrogram_beta(i_generada,Ts,ancho_ventana_ceps,corrimiento);
x = [0 2.65];
y = [2 20];
...
colorbar
print('tiempo_quefrencia_i_13.png','-dpng');

[ceps_o,foo,tfoo]=cepstrogram_beta(o_generada,Ts,ancho_ventana_ceps,corrimiento);
x = [0 2.65];
y = [2 20];
...
colorbar
print('tiempo_quefrencia_o_13.png','-dpng');

[ceps_u,fou,tfou]=cepstrogram_beta(u_generada,Ts,ancho_ventana_ceps,corrimiento);
x = [0 2.65];
y = [2 20];
...
colorbar
print('tiempo_quefrencia_u_13.png','-dpng');
...
print('spec_a_generada_13.png','-dpng');
...
print('spec_e_generada_13.png','-dpng');
...
print('spec_i_generada_13.png','-dpng');
...
print('spec_o_generada_13.png','-dpng');
...
print('spec_u_generada_13.png','-dpng');
%DFT
figure (6)
...
ylabel('Amplitud');
xlabel('Frecuencia [Hz]');
print('dft_a_generada_13.png','-dpng');
...
ylabel('Amplitud');
xlabel('Frecuencia [Hz]');
print('dft_e_generada_13.png','-dpng');
...
ylabel('Amplitud');
xlabel('Frecuencia [Hz]');
print('dft_i_generada_13.png','-dpng');
...
ylabel('Amplitud');
xlabel('Frecuencia [Hz]');
print('dft_o_generada_13.png','-dpng');
...
xlabel('Frecuencia [Hz]');
ylabel('Amplitud');
print('dft_u_generada_13.png','-dpng');
